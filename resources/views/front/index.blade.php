...
<div class="banner-carousel banner-carousel-1 mb-0">
  <div class="banner-carousel-item" style="background-image:url({{asset('front/images')}}/slider-main/bg1.jpg)">
          ...
          <div class="row align-items-center h-100">
              <div class="col-md-12 text-center">
                ...
                <p data-animation-in="slideInLeft" data-duration-in="1.2">
                    <a href="{{ route("front.services-list") }}" class="slider btn btn-primary">Our Services</a>
                    <a href="{{ route("front.contact") }}" class="slider btn btn-primary border">Contact Now</a>
                </p>
              </div>
          </div>
        </div>
  ...
  <div class="banner-carousel-item" style="background-image:url({{asset('front/images')}}/slider-main/bg2.jpg)">
          ...
          <div class="row align-items-center h-100">
              <div class="col-md-12">
                ...
                <p data-animation-in="slideInRight">
                    <a href="{{ route("front.services-list") }}" class="slider btn btn-primary border">Our Services</a>
                </p>
              </div>
          </div>
        </div>
  ...
  <div class="banner-carousel-item" style="background-image:url({{asset('front/images')}}/slider-main/bg3.jpg)">
          ...
          <div class="row align-items-center h-100">
              <div class="col-md-12">
                ...
                <div data-animation-in="slideInLeft">
                    <a href="{{ route("front.contact") }}" class="slider btn btn-primary" aria-label="contact-with-us">Get Free Quote</a>
                    <a href="{{ route("front.about-us") }}" class="slider btn btn-primary border" aria-label="learn-more-about-us">Learn more</a>
                </div>
              </div>
          </div>
        </div>
...
@include('front.partials.blocks.projects')
@include('front.partials.blocks.news')
@endsection
